...
const SidebarHistoryChat = () => {
  ...
  return (
    <div className="p-4 bg-gray-600 min-w-[320px] w-[320px]">
      ...
      <div className="flex items-center bg-gray-500 rounded-lg p-1 mt-6">
...
export default SidebarHistoryChat;
